...
namespace imClickable
{
    internal static class SDL2Functions
    {
        ...
        private static readonly SDL_GetDisplayBounds_int_SDL_Rect_t s_SDL_GetDisplayBounds_int_SDL_Rect_t =
            Sdl2Native.LoadFunction<SDL_GetDisplayBounds_int_SDL_Rect_t>("SDL_GetDisplayBounds");
        ...
        public static int SDL_GetDisplayBounds(int displayIndex, ref Rectangle rect) =>
            s_SDL_GetDisplayBounds_int_SDL_Rect_t(displayIndex, ref rect);
    }
}